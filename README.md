The sources for a simplr personal website based on [Phantom](https://github.com/jamigibbs/phantom) by [Jami Gibbs](https://github.com/jamigibbs/)

The descritpion below is from the original repo.
### Phantom for Jekyll
